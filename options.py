"""CLI argument parser for training and inference.
Defines shared options (name, dataroot, batch_size, pretrained, etc.)
and mode-specific options for training (-lr, -fm, -ab, etc.) and testing (-val, -ls, etc.).
"""
...
class Options():
    ...
    def add_training_options(self):
        ...
        self.parser.add_argument('--learning_rate', '-lr', default=5e-6, type=float,
                                 help="Learning rate")
        ...
        self.parser.add_argument('--not_log_samples', '-nls', action='store_true',
                                 help='Disable sample logging during training')
        self.parser.add_argument('--wandb_log_images', '-wli', action='store_true',
                                 help='Upload training sample images to wandb')
