...
# TODO: Current trainer is ineffective for Deepspeed ZeRO3 partition.
    ...
    def timedepend_preprocess(self, cond, t):
        ...
        if self.ucg_rate > 0:
            crossattn = zero_drop(
                ...
                if self.dynamic_ucg else self.ucg_rate
            ) * crossattn
