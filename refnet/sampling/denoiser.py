...
class CFGDenoiser(nn.Module):
    ...
    def __init__(self, model, device):
        ...
        self.gram_visualizer = None  # Will be set by backend if needed
    ...
    def forward(
        ...
        # Increment gram visualizer step counter after model forward pass
        if self.gram_visualizer is not None and self.gram_visualizer.enabled:
            self.gram_visualizer.increment_step()
...
class DiffuserDenoiser:
    ...
    def __call__(
        ...
        for i, t in enumerate(tqdm(timesteps)):
            ...
            # Increment gram visualizer step counter if exists
            if hasattr(unet, 'gram_visualizer') and unet.gram_visualizer is not None:
                unet.gram_visualizer.increment_step()
